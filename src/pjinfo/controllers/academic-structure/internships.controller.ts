...
import {
  CreateInternshipPjInfoDto,
  EditInternshipPjInfoDto,
} from '../../dtos/academic-structure/internships/internships-input.dto';
import { ResponseInternshipPjInfoDto } from '../../dtos/academic-structure/internships/internships-response.dto';
...
@ApiTags('Institutional -- Internships')
@UseGuards(JwtGuard, RolesGuard)
@Controller('pj/:pjId')
export class InternshipsPjInfoController {
  constructor(
  ...
  @PJRoles('basico')
  @Get('internships')
  async getUserInternship(@GetUser('id') userId: string): Promise<Array<ResponseInternshipPjInfoDto>> {
  ...
  async createInternship(
    ...
    @Body() dto: CreateInternshipPjInfoDto,
  ): Promise<ResponseInternshipPjInfoDto> {
    const pj = await this.auxService.getPjInfo(userId);
  ...
  async editInternship(
    @GetUser('userId') userId: string,
    @Param('id') internshipId: string,
    @Body() dto: EditInternshipPjInfoDto,
  ): Promise<ResponseInternshipPjInfoDto> {
  ...
  private getInternshipResponse(internship: TIntershipWithCurriculumOutput): ResponseInternshipPjInfoDto {
    return {
