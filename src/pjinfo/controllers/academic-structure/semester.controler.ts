...
import {
  CreateSemesterPjInfoDto,
  EditSemesterPjInfoDto,
  SubjectsToSemesterPjInfoDto,
} from '../../dtos/academic-structure/semesters/semesters-input.dto';
import { ResponseSemesterPjInfoDto } from '../../dtos/academic-structure/semesters/semesters-response.dto';
...
@ApiTags('Institutional -- Semesters')
@UseGuards(JwtGuard, RolesGuard)
@Controller('pj/:pjId')
export class SemestersPjInfoController {
  constructor(
  ...
  ): Promise<Array<ResponseSemesterPjInfoDto>> {
  ...
  async createSemester(
    @GetUser('id') userId: string,
    @Param('curriculumId') curriculumId: string,
    @Body() dto: CreateSemesterPjInfoDto,
  ): Promise<ResponseSemesterPjInfoDto> {
    const semesters = await this.semesterService.getCurriculumSemesters(curriculumId);
  ...
  async editSemester(
    ...
    @Body() dto: EditSemesterPjInfoDto,
  ): Promise<ResponseSemesterPjInfoDto> {
  ...
  async addSubjectsToSemester(
    ...
    @Body() dto: SubjectsToSemesterPjInfoDto,
  ): Promise<ResponseSemesterPjInfoDto> {
  ...
  private getSemesterResponse(semester: TSemesterWithSubjectsOutput): ResponseSemesterPjInfoDto {
    return {
