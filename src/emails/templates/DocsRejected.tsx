...
export default function DocsRejected ({
  var1,
  var2,
  var3,
  var4,
  ...
  return (
    <Html>
      <Head />
      <Preview>CertifikEdu Rejected Document</Preview>
      <Body style={main}>
        <Container style={container}>
          <Section style={coverSection}>
            ...
            <Section style={upperSection}>
              <Text style={mainText}>{var2}{"{{ name }}"}</Text>
              <Text style={subMainText}>{var3}</Text>
              <Text style={verifyText}>{var4}</Text><br />
              <Button style={button} href="https://app.certifikedu.com/authentication/sign-in">
                {var5}
              </Button>
              <Text style={subMainText}>
                {var6}
                <Text style={emailText}>{var7}</Text>
              </Text>
            </Section>
