...
export default function DocsApproved ({
  var1,
  var2,
  var3,
  var4,
  ...
  return (
    <Html>
      <Head />
      <Preview>CertifikEdu Approved Document</Preview>
      <Body style={main}>
        <Container style={container}>
          <Section style={coverSection}>
            ...
            <Section style={upperSection}>
              ...
              <Button style={button} href="https://certifikedu.com">
                {var5}
              </Button>
            </Section>
