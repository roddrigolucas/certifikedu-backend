...
-- AlterTable
ALTER TABLE "PessoaFisica" ALTER COLUMN "CPF" SET DATA TYPE BIGINT;

-- AlterTable
ALTER TABLE "PessoaJuridica" ALTER COLUMN "CNPJ" SET DATA TYPE BIGINT;

-- AlterTable
ALTER TABLE "Socios" ALTER COLUMN "CPF" SET DATA TYPE BIGINT;

-- AlterTable
ALTER TABLE "certificates" ALTER COLUMN "receptorDoc" SET DATA TYPE BIGINT,
ALTER COLUMN "emissorDoc" SET DATA TYPE BIGINT;

-- AlterTable
ALTER TABLE "users" ALTER COLUMN "numeroDocumento" SET DATA TYPE BIGINT;
